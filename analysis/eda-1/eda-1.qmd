...
This document demonstrates **data genealogy** within analytical workflows using the Motor Trend Car Road Tests dataset. We track data transformations through a clear lineage:
...
-   **Analytical Focus**: How engine cylinder count affects vehicle performance characteristics

**Key Analytical Questions:** - How does cylinder count relate to horsepower and fuel efficiency? - What performance patterns emerge when we aggregate individual vehicles by engine configuration? - How can we track data transformations to maintain analytical transparency?
...
This report demonstrates **data genealogy** using the Motor Trend Car Road Tests dataset:
...
**Transformation Pipeline:** ds0 → g2-data-prep → g2_data → g2 visualization
