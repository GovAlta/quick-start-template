...
<details>
   <summary> Click to unfold a more technical description of data origin to help you understand the tables used in the report. However, we encourage to start with `Data Description` section first, and come back here if more details desired "<span class="glyphicon glyphicon-plus-sign"></span></summary>
