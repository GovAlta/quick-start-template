...
# ---- define-queries ----------------------------------------------------------
# Define SQL query to extract data from the database
sql_query <- "
...
# Load all event types for comprehensive event table
# Financial Support episodes (primary focus)
ds_data <- DBI::dbGetQuery(cnn, sql_query)
